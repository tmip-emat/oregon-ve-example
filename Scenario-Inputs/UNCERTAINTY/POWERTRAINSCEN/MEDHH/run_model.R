...
requirePackage(VEPowertrainsAndFuelsAP2022amedhh)
...
for(Year in getYears()) {
  ...
  runModule("CalculateCarbonIntensity",        "VEPowertrainsAndFuelsAP2022amedhh",   RunFor = "AllYears",    RunYear = Year)
  runModule("AssignHhVehiclePowertrain",       "VEPowertrainsAndFuelsAP2022amedhh",   RunFor = "AllYears",    RunYear = Year)
  for (i in 1:2) {
